...
print "The top score for these ingredients at 500 calories is: $topScore\n";
...
sub getScore(){
	...
	$calories += $ingredients[$i][5] * $spoons[$i];
    }
    ...
    #return the product of the scores in the array if calories = 500
    if($calories == 500){
